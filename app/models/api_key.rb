...
class ApiKey < ApplicationRecord
  ...
  RESOURCES = %w[
    ...
    payment_provider tax wallet wallet_transaction webhook_endpoint webhook_jwt_public_key invoice_custom_section
    billing_entity alert feature security_log quote apple_iap_order
  ].freeze
